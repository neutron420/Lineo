                ...
                <div className="mx-auto grid gap-4 lg:grid-cols-2">
                    <FeatureCard>
                        <CardHeader className="pb-3">
                            <CardHeading
                                ...
                                description="Live updates for every customer. Never lose track of your position."
                            />
                        </CardHeader>
                    ...
                    <FeatureCard>
                        <CardHeader className="pb-3">
                            <CardHeading
                                icon={Calendar}
                                title="Intelligence Dispatching"
                                description="Automatically assign customers to the next available counter."
                            />
                        </CardHeader>
                        ...
                        <CardContent>
                            <div className="relative mb-6 sm:mb-0">
                                ...
                                <div className="aspect-[76/59] border">
                                    <DualModeImage
                                        darkSrc="/ticketing-light.png"
                                        lightSrc="/ticketing-light.png"
                                        alt="Ticketing Interface"
                                        width={1207}
                                        height={929}
                                    />
                                </div>
                    ...
                    <FeatureCard className="p-6 lg:col-span-2">
                        <p className="mx-auto my-6 max-w-md text-balance text-center text-2xl font-semibold">Integrated SMS & WhatsApp notifications for zero missed turns.</p>
