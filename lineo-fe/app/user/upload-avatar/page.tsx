...
export default function UploadAvatarPage() {
  return (
    <div className="min-h-screen bg-[#f7fafd] flex flex-col items-center justify-center p-4 selection:bg-[#493ee5]/10">
      <Suspense fallback={<div className="w-full max-w-md bg-white rounded-[32px] p-8 md:p-10 shadow-2xl animate-pulse flex flex-col items-center"><Loader2 className="w-8 h-8 animate-spin text-[#493ee5]" /></div>}>
        <UploadAvatarContent />
      </Suspense>
    </div>
  );
